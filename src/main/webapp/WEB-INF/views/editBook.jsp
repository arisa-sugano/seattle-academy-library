        ...
        <form action="<%=request.getContextPath()%>/updateBook" method="post" enctype="multipart/form-data" id="data_upload_form">
            ...
            <div class="content_body add_book_content">
                <div>
                    ...
                    <c:if test="${'null'== bookDetailsInfo.thumbnailUrl}">
                ...
                <div class="content_right">
                    ...
                    <div>
                        ...
                        <c:if test="${empty bookDetailsInfo}">
                            <input type="text" required name="author" autocomplete="off">
                        </c:if>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <c:if test="${!empty bookDetailsInfo}">
                            <input type="text" name="publishe_Date" value="${bookDetailsInfo.publishDate}">
                        </c:if>
                        <c:if test="${empty bookDetailsInfo}">
                            <input type="text" required name="publishe_Date">
                        </c:if>
                    </div>
                    <div>
